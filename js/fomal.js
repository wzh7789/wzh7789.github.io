...
$.ajax({
  ...
  data: {
    key: 'UFPBZ-B36RL-OYQP3-MVGQ5-VIA6J-XEF3I',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(116.021292, 29.676931 , ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("04/07/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function share_() {
  ...
  try {
    ...
    navigator.clipboard.writeText('Wzh🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = '(ノへ￣、)别跑~';
    clearTimeout(titleTime);
  } else {
    //返回当前页面时标签显示内容
    document.title = '(￣rǒ￣)你还知道回来啊';
    //两秒后变回正常标题
...
function createtime() {
  ...
  var start = new Date("04/05/2023 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("04/05/2023 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://imgbed.link/file/26942);
    --darkmode-bg:url(https://imgbed.link/file/26942);
    --mobileday-bg: url(https://imgbed.link/file/26942);
    --mobilenight-bg: url(https://imgbed.link/file/26942);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26996)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26996)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26997)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26997)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26993)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26993)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26992)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26992)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26990)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26990)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26986)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26986)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26981)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26981)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26973)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26973)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26974)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26974)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26954)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26954)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26951)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26951)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26943)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26943)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26925)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26925)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://imgbed.link/file/26933)" class="imgbox" onclick="changeBg('url(https://imgbed.link/file/26933)')"></a>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/x6/wallhaven-x679zz.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/x6/wallhaven-x679zz.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/gp/wallhaven-gpq1lq.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/gp/wallhaven-gpq1lq.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/qz/wallhaven-qz3l7d.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/qz/wallhaven-qz3l7d.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/we/wallhaven-welokx.png)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/we/wallhaven-welokx.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/x6/wallhaven-x67prv.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/x6/wallhaven-x67prv.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/gp/wallhaven-gpqye7.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/gp/wallhaven-gpqye7.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/gp/wallhaven-gpqgoq.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/gp/wallhaven-gpqgoq.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://w.wallhaven.cc/full/6d/wallhaven-6d57ox.jpg)" class="imgbox" onclick="changeBg('url(https://w.wallhaven.cc/full/6d/wallhaven-6d57ox.jpg)')"></a></div>
              </div>
            </details>
